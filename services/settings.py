...
METRIC_BOARDS = [
    ...
    ("daily", "Most in a Day", "Most distance in a single day"),
    ("week", "Most in a Week", "Most distance in one week"),
    ("month", "Most in a Month", "Most distance in one calendar month"),
    ("speed", "Top Speed", "Highest speed reached on any ride"),
    ("accel", "0→40 km/h", "Fastest launch from a stop to 40 km/h · lower is better"),
    ("gforce", "Top G-Force", "Strongest g-force spike"),
    ("power", "Peak Power (2s)", "Highest power held for 2 seconds"),
    ("current", "Peak Current (2s)", "Highest current held for 2 seconds"),
    ("voltage", "Peak Voltage", "Highest battery voltage observed"),
    ("streak", "Streak Master", "Longest run of consecutive days ridden"),
    ("ascent", "Most Climbing", "Total elevation climbed (Everest = 8849 m)"),
    ("range", "Best Range", "Longest estimated full-charge range"),
    ("efficiency", "Best Efficiency", "Lowest energy use per km · most efficient"),
    ("hours", "Steel Legs", "Most hours on the wheel"),
    ("cruise", "Longest Calm Ride", "Longest calm ride held under 10 km/h"),
    ...
    ("marathon", "Longest Single Ride", "Longest single ride by time"),
    ("pace", "Best Avg Speed", "Highest average speed on a single ride"),
    ("battery", "Biggest Battery Drain", "Biggest battery drain in one ride"),
    ...
    ("peak", "Biggest Single Climb", "Biggest elevation gain in a single ride"),
    ("energy", "Most Energy Used", "Most total energy used across all rides"),
    ("explorer", "Explorer", "Most distinct map areas ridden"),
    ("bigday", "Most Rides in a Day", "Most rides in a single day"),
    ("commuter", "Commuter", "Most distance ridden on weekdays"),
    ("freespin", "Biggest Freespin", "Biggest freespin / spin-up spike (wheel lifted or a crash)"),
    ("sag", "Biggest Voltage Sag", "Biggest voltage drop under load — the hardest battery pull"),
...
METRIC_GROUPS = [
    ...
    ("gforce", "Top G-Force", "Strongest g-force spike"),
    ("power", "Peak Power (2s)", "Highest power held 2s"),
    ("current", "Peak Current (2s)", "Highest current held 2s"),
    ("voltage", "Peak Voltage", "Highest battery voltage"),
    ("riders", "Riders", "Active riders"),
    ("trips", "Rides", "Rides logged"),
    ("ascent", "Most Climbing", "Total elevation climbed"),
    ("range", "Best Range", "Longest est. range"),
    ("eff", "Best Efficiency", "Lowest Wh/km · best"),
]
...
_GATED_SPEC = [
    ("power",    "Peak Power (2s)",       "Highest power held for 2 seconds",        "max_sustained_w",  "max", " W",       "",     "power"),
    ("current",  "Peak Current (2s)",        "Highest current held for 2 seconds",      "max_sustained_a",  "max", " A",       "",     "current"),
    ("sag",      "Biggest Voltage Sag",         "Biggest voltage drop under load",         "max_voltage_sag",  "max", " V",       "",     "sag"),
    ("rocket",   "Rocket",           "Hardest sustained acceleration (2s+)",    "sustained_accel",  "max", " km/h/s",  "",     "rocket"),
    ("battery",  "Biggest Battery Drain",  "Biggest battery drain in one ride",       "battery_used_pct", "max", " %",       "",     "battery"),
    ("temphigh", "Highest Temperature",          "Hottest the board ever ran",              "max_temp",         "max", "°",   "temp", "rocket"),
    ("templow",  "Lowest Temperature",        "Coldest ride",                            "min_temp",         "min", "°",   "temp", "streak"),
    ("pwm",      "Peak PWM",          "Closest to maxing the motor (PWM)",       "max_pwm",          "max", " %",       "",     "speed"),
    ("battlow",  "Lowest Battery %", "Lowest battery % reached",                "min_battery_pct",  "min", " %",       "",     "range"),
    ...
    ("pwm3",     "PWM Hold (3s)",     "Highest PWM held for 3 seconds",          "pwm_sust_3s",      "max", " %",       "",     "speed"),
    ("spd5",     "Top Speed (5s)",      "Highest speed held for 5 seconds",        "speed_sust_5s",    "max", " km/h",    "spd",  "speed"),
    ("spd10",    "Top Speed (10s)",     "Highest speed held for 10 seconds",       "speed_sust_10s",   "max", " km/h",    "spd",  "speed"),
    ("pw6",      "Peak Power (6s)",    "Highest power held for 6 seconds",        "power_sust_6s",    "max", " W",       "",     "power"),
    ("cur6",     "Peak Current (6s)",     "Highest current held for 6 seconds",      "current_sust_6s",  "max", " A",       "",     "current"),
    # --- g-force while genuinely fast ---
    ("gf20",     "G above 20 km/h",  "Strongest g-force sustained above 20 km/h", "g_fast_20",      "max", "",         "",     "gforce"),
    ("gf30",     "G above 30 km/h",  "Strongest g-force sustained above 30 km/h", "g_fast_30",      "max", "",         "",     "gforce"),
    ("gf40",     "G above 40 km/h",  "Strongest g-force sustained above 40 km/h", "g_fast_40",      "max", "",         "",     "gforce"),
    # --- experimental shake (the fakeable IMU brake/lateral boards were dropped) ---
    ("shake",    "Wobble Index",   "Biggest speed-wobble / shake index (experimental)", "shake_index", "max", "",   "",     "gforce"),
    # --- speed turned into a longitudinal g-force: launch (green) and braking (red) ---
    ("accg",     "Acceleration G",     "Hardest acceleration as a g-force (from speed)",    "accel_g", "max", " g",     "",     "accel"),
    ...
    ("acc30",    "Accel G above 30",       "Hardest acceleration g while already above 30 km/h","accel_g_30","max", " g",     "",     "accel"),
    ("acc50",    "Accel G above 50",       "Hardest acceleration g while already above 50 km/h","accel_g_50","max", " g",     "",     "accel"),
...
_UNGATED_NEW = [
    ("althigh",  "Highest Altitude",         "Highest altitude ever reached", "max_altitude_m", "max", " m", "alt", "ascent"),
    ("altlow",   "Lowest Altitude",  "Lowest altitude ever reached",  "min_altitude_m", "min", " m", "alt", "altking"),
]
