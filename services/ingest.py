    ...
    def handle(self, meta: dict, raw_bytes: bytes) -> dict:
        ...
        try:
            trip = self.trips.insert_trip(
                ...
                cutout_count=sm.cutout_count, spin_count=sm.spin_count,
                ...
                t_0_60_s=sm.t_0_60_s, t_0_100_s=sm.t_0_100_s,
                accel_g_30=sm.accel_g_30, accel_g_50=sm.accel_g_50,
                brake_g_30=sm.brake_g_30, brake_g_50=sm.brake_g_50,
